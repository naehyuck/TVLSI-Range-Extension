...
\caption{\textcolor{red}{Velocity profile comparison with cost functions of $EDP$, $E^2DP$ and $E^3DP$ on the benchmark Cliff Drive in Santa Barbara.}}
\label{fig:EDP_aware_velocity_planning}
\end{figure*} 

\begin{figure*} %Figure 11 candidate 1
\centering
\includegraphics[width=0.9\hsize]{Figures/EDP_comp_profile_case1.pdf}
\caption*{\textcolor{red}{Velocity profile comparison with cost functions of $EDP$, $E^2DP$ and $E^3DP$ on the benchmark Jones Street in San Francisco (candidate 1 of Fig. 11).}}
\label{fig:EDP_aware_velocity_planning}
\end{figure*} 

\begin{figure*} %Figure 11 candidate 2
\centering
\includegraphics[width=0.9\hsize]{Figures/EDP_comp_profile_case2.pdf}
\caption*{\textcolor{red}{Velocity profile comparison with cost functions of $EDP$, $E^2DP$ and $E^3DP$ on the benchmark Serrano Avenue between San Fransisco and San Jose (candidate 2 of Fig. 11).}}
\label{fig:EDP_aware_velocity_planning}
\end{figure*} 
